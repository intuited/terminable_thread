...
-   Only exception **types** can be raised safely. Exception
    ...
    -   IMHO it's a bug, and I reported it as one. For more
        info, [http://mail.python.org/pipermail/python-dev/2006-August/068158.html] 
...
For an example of this, see the test suite for the [pqueue_fetcher] module.

I guess I'll move that test into this module at some point.
...
[http://mail.python.org/pipermail/python-dev/2006-August/068158.html]: http://mail.python.org/pipermail/python-dev/2006-August/068158.html
